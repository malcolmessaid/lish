...
// the user clicks highlight in the right-click menu. It gathers necesassy information about the selection and stores
...
function MyRange(select) {
  ...
  this.spanTagsComplex = function(){
    ...
    // The beginning and end nodes are edge cases becasue the only a portion of the node will highlight
    ...
    // Loops throught the nodesInSelection field, but it starts at 1 and ends once before the end becasue it deals with only
    // middle nodes.
